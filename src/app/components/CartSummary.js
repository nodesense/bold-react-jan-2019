...
// compare nextState with current state, return true/false
export default class CartSummary extends PureComponent {
    ...
    // called whenever parent component render called on update cycle
    // called whether data changed or not
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.count != nextProps.count || 
            this.props.amount != nextProps.amount) {
                console.log('recalculate discount');
